...
<html lang="en">
	...
	?>
		...
		<!-- Banner -->
			...
			<h1 style="font-family: 'Imprint MT Shadow';color:white; cursive;">AgroCulture &copy; </h1>
		...
		<!-- Footer -->
		<footer class="footer-distributed" style="background-color:blueviolet;" id="aboutUs">
		<center>
			<h1 style="font: 35px Imprint MT Shadow;color: white;">About Us</h1>
		</center>
		<div class="footer-left">
			<h3 style="font-family: 'Imprint MT Shadow';color:white; cursive;">AgroCulture &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Market<span>Emali</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">0790723820</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px;;"><a href="mailto:agroculture@gmail.com" style="color:white">brianmwololo89@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px;color:beige;font-family:Algerian;"><b>About AgroCulture Market</b></span>
				</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                             ...
				                             <input type="radio" id="login_farmer" name="category" value="1" required>
                                             <label for="login_farmer">Farmer</label>
				                        </div>
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="login_buyer" name="category" value="2" required>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <div class="3u 12u$(small)">
			                             <input type="radio" id="signup_farmer" name="category" value="1" required>
                                         <label for="signup_farmer">Farmer</label>
			                        </div>
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id="signup_buyer" name="category" value="2" required>
			                            <label for="signup_buyer">Buyer</label>
			                        </div>
								</div>
								<div class="row uniform">
